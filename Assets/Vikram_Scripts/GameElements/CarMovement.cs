...
public class CarMovement : MonoBehaviour, IVehicleMovement
{
    ...
    void Update()
    {
        ...
        if (hitObstacle)
        {
            ...
            if ((distanceToObstacle > toleranceDistance))
            {
                ...
                //float requiredDecel = (currentSpeed * currentSpeed) / (2f * distanceToObstacle);
        ...
        if(vehicleWheelRotation != null)
        {
            vehicleWheelRotation.currentSpeed = currentSpeed;
        }
